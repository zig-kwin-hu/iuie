...
declare -A TASK2DATASETS=([re]="SciERC")
...
lora_target_modules=q_proj,v_proj,up_proj,o_proj,k_proj,down_proj,gate_proj
# model_name_or_path=google/flan-t5-xxl
#model_name_or_path=/storage/zkhu/InstructUIE/Llama-2-7b
