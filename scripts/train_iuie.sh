...
declare -A TASK2DATASETS=([multi_task]="all" [ner]="" [re]="SciERC ADE_corpus-1500" [with_sentence_iuie_mean_of_encoder]="0_2" [ner_cluster]="ACE_2004_ACE_2005" [re_cluster]="NYT11_NYT" [eet]="ace phee casie" [eea]="ace phee casie")
...
model_name_or_path=ZWK/InstructUIE
# model_name_or_path=wenge-research/yayi-uie
    ...
    do
        ...
        if [[ "${add_name}" == "True" ]]; then
            if [[ "${moe_lora}" == "True" ]]; then
                output_dir="output_ssd2/${TASK_CONFIG}_moelora/${DATASET_CONFIG}/${cluster_short_name}/${name_after_slash}_addname_${lora_r}_${lora_target_modules}_${gate_type}_${expert_num}_${moe_topk}_${gate_loss_type}_${add_noise}_${regularized}_${with_universal}_${gate_weight_initalized_from_existing}"
            else
                output_dir="output_ssd2${TASK_CONFIG}_lora/${DATASET_CONFIG}/${name_after_slash}_addname_${lora_r}_${lora_target_modules}"
            fi
        else
            if [[ "${moe_lora}" == "True" ]]; then
                output_dir="output_ssd2/${TASK_CONFIG}_moelora/${DATASET_CONFIG}/${cluster_short_name}/${name_after_slash}_${lora_r}_${lora_target_modules}_${gate_type}_${expert_num}_${moe_topk}_${gate_loss_type}_${add_noise}_${regularized}_${with_universal}_${gate_weight_initalized_from_existing}"
            else
                output_dir="output_ssd2/${TASK_CONFIG}_lora/${DATASET_CONFIG}/${name_after_slash}_${lora_r}_${lora_target_modules}"
            fi
        fi
        ...
        --moe_topk ${moe_topk} \
        --before_moe_lora_gate_embedding_reduction ${before_moe_lora_gate_embedding_reduction} \
