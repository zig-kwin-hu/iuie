...
if is_bnb_available():
    ...
    class MOELinear8bitLt(torch.nn.Module, MOELoraLayer):
        ...
        def __init__(
            ...
            **kwargs,
            ...
            super().__init__()
            MOELoraLayer.__init__(self, in_features=base_layer.in_features, out_features=base_layer.out_features)
...
if is_bnb_4bit_available():
    ...
    class MOELinear4bit(torch.nn.Module, MOELoraLayer):
        # Lora implemented in a dense layer
        def __init__(
            self,
            adapter_name,
