...
from peft_moe.tuners.moelora.layer import MOELoraLayer


class MOEQuantLinear(torch.nn.Module, MOELoraLayer):
    def __init__(
        self,
        adapter_name,
        quant_linear_module,
        ...
        **kwargs,
        ...
        raise NotImplementedError("MOEQuantLinear is not implemented yet")
